            ...
            <?php if ( ! empty( $image['image_sp'] ) && ! empty( $image['image_pc'] ) ) : ?>
              <div class="swiper-slide">
                <picture class="mv__img">
                  ...
                  <!-- pcの画像 -->
                  <img src="<?php echo esc_url( $image_url_pc ); ?>" alt="<?php echo esc_attr( $image_alt ); ?>" width="1440" height="768" loading="eager">
                </picture>
              </div>
            <?php endif; ?>
          <?php
  ...
  <section class="layout-plans plans">
    <div class="plans__inner inner">
      ...
      <div class="plans__btn">
        <a href="<?php echo $plans; ?>" class="button" aria-label="ご提供プランの一覧を見る"><span class="button__text">View&nbsp;more</span></a>
      </div>
    </div>
  </section>
      ...
      <div class="information__content">
        ...
        <div class="information__text-body">
          ...
          <div class="information__btn">
            <a href="<?php echo $information; ?>" class="button" aria-label="身辺警護についての情報のページを見る"><span class="button__text">View&nbsp;more</span></a>
          </div>
        </div>
      </div>
    </div>
