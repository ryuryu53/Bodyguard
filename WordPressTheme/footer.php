            ...
            <div class="contact__wrapper">
              ...
              <div class="contact__inquiry">
                ...
                <div class="contact__btn">
                  <a href="<?php echo $contact; ?>" class="button" aria-label="お問い合わせページへ移動"><span class="button__text">Contact&nbsp;us</span></a>
                </div>
              </div>
            </div>
          </div>
    ...
    <footer class="layout-footer<?php
      ...
      <div class="footer__inner inner">
        ...
        <nav class="footer__nav footer-nav" aria-label="フッターのメインメニュー">
          <div class="footer-nav__left-content">
            ...
            <ul class="footer-nav__left-items">
              <li class="footer-nav__left-item">
                ...
                <ul class="footer-nav__left-detail-items">
                  <li class="footer-nav__left-detail-item">
                    <a href="<?php echo $information; ?>?tab=panel-1" class="footer-nav__left-detail-link">身体を守る防護壁</a>
                  </li>
                  <li class="footer-nav__left-detail-item">
                    <a href="<?php echo $information; ?>?tab=panel-2" class="footer-nav__left-detail-link">安心感のサポート</a>
                  </li>
                  <li class="footer-nav__left-detail-item">
                    <a href="<?php echo $information; ?>?tab=panel-3" class="footer-nav__left-detail-link">危険察知と回避</a>
                  </li>
                </ul>
              </li>
              <li class="footer-nav__left-item">
